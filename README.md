...
In this repository, we use several examples which can be downloaded from [zenodo](https://zenodo.org/records/7463996) (S16_dataset_1.zip/2022-08-03.zip) to show the process of data preprocessing, including *file convert*, *data visualization* and basic *data analysis*. We hope this can provide a basic idea to those who want to explore more on this dataset. If you have further contributions to this repository, welcome to [contact](subin_lin@u.nus.edu) us.
